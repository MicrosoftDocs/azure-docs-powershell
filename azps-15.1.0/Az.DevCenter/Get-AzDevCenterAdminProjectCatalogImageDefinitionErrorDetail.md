...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/get-azdevcenteradminprojectcatalogimagedefinitionerrordetail
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DevCenter/DevCenter/help/Get-AzDevCenterAdminProjectCatalogImageDefinitionErrorDetail.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DevCenter/DevCenter/help/Get-AzDevCenterAdminProjectCatalogImageDefinitionErrorDetail.md
---
...
### Get (Default)
```
Get-AzDevCenterAdminProjectCatalogImageDefinitionErrorDetail -CatalogName <String>
...
### GetViaIdentity
```
Get-AzDevCenterAdminProjectCatalogImageDefinitionErrorDetail -InputObject <IDevCenterIdentity>
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
