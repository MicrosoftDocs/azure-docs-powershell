...
```
New-AzPurviewAmazonPostgreSqlCredentialScanObject [-CollectionReferenceName <String>]
 ...
 [-ScanRulesetType <String>] [-ServerEndpoint <String>] [-VpcEndpointServiceName <String>] [-Worker <Int32>]
 [<CommonParameters>]
```
