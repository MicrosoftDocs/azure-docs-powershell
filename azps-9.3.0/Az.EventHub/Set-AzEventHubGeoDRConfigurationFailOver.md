...
online version: https://learn.microsoft.com/powershell/module/az.eventhub/set-azeventhubgeodrconfigurationfailover
schema: 2.0.0
...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.eventhub/set-azeventhubgeodrconfigurationfailover) for up-to-date information.
...
### FailViaIdentity
```
Set-AzEventHubGeoDRConfigurationFailOver -InputObject <IEventHubIdentity> [-DefaultProfile <PSObject>] [-AsJob]
