...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/NetworkFunction/NetworkFunction/help/Remove-AzNetworkFunctionCollectorPolicy.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/NetworkFunction/NetworkFunction/help/Remove-AzNetworkFunctionCollectorPolicy.md
...
```
Remove-AzNetworkFunctionCollectorPolicy -Name <String>
 -AzureTrafficCollectorInputObject <INetworkFunctionIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
