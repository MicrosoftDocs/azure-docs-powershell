...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DataTransfer/DataTransfer/help/Approve-AzDataTransferConnection.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DataTransfer/DataTransfer/help/Approve-AzDataTransferConnection.md
...
```
Approve-AzDataTransferConnection -PipelineName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```yaml
Type: System.String
Parameter Sets: ApproveExpanded, ApproveViaJsonString, ApproveViaJsonFilePath, Approve
Aliases:
