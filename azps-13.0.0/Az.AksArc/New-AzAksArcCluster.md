...
```powershell
New-AzAksArcCluster -ClusterName azps_test_cluster -ResourceGroupName azps_test_group -AdminGroupObjectID @("00001111-aaaa-2222-bbbb-3333cccc4444", "1b28ff4f-f7c5-4aaa-aa79-ba8b775ab443")
```
