...
### System.String
Parameters: AuthenticationMethod (ByPropertyName), Name (ByPropertyName), ProcessorArchitecture (ByPropertyName), RadiusRootCertificateFile (ByPropertyName), ResourceGroupName (ByPropertyName)
