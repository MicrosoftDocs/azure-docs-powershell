...
### System.String
Parameters: ExtensionPublisherName (ByPropertyName), ExtensionType (ByPropertyName), Name (ByPropertyName), ResourceGroupName (ByPropertyName), VMName (ByPropertyName)
