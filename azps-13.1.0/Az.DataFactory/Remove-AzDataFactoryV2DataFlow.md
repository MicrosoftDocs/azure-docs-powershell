...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DataFactory/DataFactory/help/Remove-AzDataFactoryV2DataFlow.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DataFactory/DataFactory/help/Remove-AzDataFactoryV2DataFlow.md
---
...
```
Remove-AzDataFactoryV2DataFlow [-Name] <String> [-PassThru] [-Force] [-ResourceGroupName] <String>
...
### ByInputObject
```
Remove-AzDataFactoryV2DataFlow [-InputObject] <PSDataFlow> [-PassThru] [-Force]
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ByResourceId
```
Remove-AzDataFactoryV2DataFlow [-PassThru] [-Force] [-ResourceId] <String>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.Commands.DataFactoryV2.Models.PSDataFlow
