...
online version: https://learn.microsoft.com/en-us/powershell/module/az.resources/new-Azroleassignment
schema: 2.0.0
...
### Example 3
```
PS C:\> New-AzRoleAssignment -SignInName john.doe@contoso.com -RoleDefinitionName Owner -Scope "/subscriptions/00001111-aaaa-2222-bbbb-3333cccc4444/resourcegroups/rg1/providers/Microsoft.Web/sites/site1"
```
