...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DurableTask/DurableTask/help/New-AzDurableTaskScheduler.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DurableTask/DurableTask/help/New-AzDurableTaskScheduler.md
...
```
New-AzDurableTaskScheduler -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-IPAllowlist <String[]>] [-SkuCapacity <Int32>] [-SkuName <String>] [-Tag <Hashtable>]
