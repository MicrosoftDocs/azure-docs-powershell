...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ScVmm/ScVmm/help/Remove-AzScVmmVMCheckpoint.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ScVmm/ScVmm/help/Remove-AzScVmmVMCheckpoint.md
...
```
Remove-AzScVmmVMCheckpoint -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Remove-AzScVmmVMCheckpoint -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Body <IVirtualMachineDeleteCheckpoint> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-WhatIf]
