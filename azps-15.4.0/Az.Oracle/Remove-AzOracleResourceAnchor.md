...
online version: https://learn.microsoft.com/powershell/module/az.oracle/remove-azoracleresourceanchor
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Oracle/Oracle/help/Remove-AzOracleResourceAnchor.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Oracle/Oracle/help/Remove-AzOracleResourceAnchor.md
---
...
### Delete (Default)
```
Remove-AzOracleResourceAnchor -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzOracleResourceAnchor -InputObject <IOracleIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
