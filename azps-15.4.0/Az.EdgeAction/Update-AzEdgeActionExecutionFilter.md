...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/EdgeAction/EdgeAction/help/Update-AzEdgeActionExecutionFilter.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/EdgeAction/EdgeAction/help/Update-AzEdgeActionExecutionFilter.md
...
```
Update-AzEdgeActionExecutionFilter -ExecutionFilter <String> -EdgeActionInputObject <IEdgeActionIdentity>
 -Property <IEdgeActionExecutionFilterUpdate> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
