...
online version: https://learn.microsoft.com/powershell/module/az.artifactsigning/get-azartifactsigningcertificateroot
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ArtifactSigning/ArtifactSigning/help/Get-AzArtifactSigningCertificateRoot.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ArtifactSigning/ArtifactSigning/help/Get-AzArtifactSigningCertificateRoot.md
---
...
```
Get-AzArtifactSigningCertificateRoot [-AccountName] <String> [-ProfileName] <String> [-EndpointUrl] <String>
...
```
Get-AzArtifactSigningCertificateRoot [-MetadataFilePath] <String> [-Destination] <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## DESCRIPTION
The **Get-AzArtifactSigningCertificateRoot** cmdlet retrieves Azure ArtifactSigning Root Cert.
Use this cmdlet to retrieve Azure ArtifactSigning Root Cert.
...
```powershell
Get-AzArtifactSigningCertificateRoot -AccountName 'contoso' -ProfileName 'contososigning' -EndpointUrl 'https://wus.artifactsigning.azure.net' -Destination 'c:\acs\certificateroot.cer'
```
...
```powershell
Get-AzArtifactSigningCertificateRoot -MetadataFilePath 'c:\cisigning\metadata_input.json' -Destination 'c:\acs\certificateroot.cer'
```
