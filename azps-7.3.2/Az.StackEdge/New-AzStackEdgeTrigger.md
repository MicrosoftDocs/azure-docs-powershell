...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.stackedge/new-azstackedgetrigger) for up-to-date information.
...
## DESCRIPTION
The **New-AzStackEdgeTrigger** cmdlet configures a trigger on the Stack Edge device. 
