...
```
PS C:\> Update-AzureRmADApplication -ObjectId 00001111-aaaa-2222-bbbb-3333cccc4444 -DisplayName MyNewDisplayName
```
...
```
PS C:\> Update-AzureRmADApplication -ObjectId 00001111-aaaa-2222-bbbb-3333cccc4444 -DisplayName MyNewDisplayName -HomePage https://www.microsoft.com -IdentifierUris "https://UpdateAppUri"
```
...
```
PS C:\> Get-AzureRmADApplication -ObjectId 00001111-aaaa-2222-bbbb-3333cccc4444 | Update-AzureRmADApplication -DisplayName MyNewDisplayName
```

Gets the application with object id '00001111-aaaa-2222-bbbb-3333cccc4444' and pipes that to the Update-AzureRmADApplication cmdlet to update the display name of the application to "MyNewDisplayName".
