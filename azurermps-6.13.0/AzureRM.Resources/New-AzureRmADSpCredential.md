...
```
PS C:\> New-AzureRmADSpCredential -ObjectId 00001111-aaaa-2222-bbbb-3333cccc4444
...
```
PS C:\> Get-AzureRmADServicePrincipal -ObjectId 00001111-aaaa-2222-bbbb-3333cccc4444 | New-AzureRmADSpCredential
...
Gets the service principal with object id '00001111-aaaa-2222-bbbb-3333cccc4444' and pipes that to the New-AzureRmADSpCredential to create a new service principal credential for that service principal with a generated password.
