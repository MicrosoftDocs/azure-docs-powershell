...
```
PS C:\> Get-AzureRmADAppCredential -ObjectId 00001111-aaaa-2222-bbbb-3333cccc4444
```
...
```
PS C:\> Get-AzureRmADApplication -ObjectId 00001111-aaaa-2222-bbbb-3333cccc4444 | Get-AzureRmADAppCredential
```

Gets the application with object id '00001111-aaaa-2222-bbbb-3333cccc4444' and pipes it to the Get-AzureRmADAppCredential cmdlet to list all of the credentials for that application.
