...
```
PS C:\>Get-AzureRmLog -CorrelationId "00001111-aaaa-2222-bbbb-3333cccc4444"
```
...
```
PS C:\>Get-AzureRmLog -CorrelationId "00001111-aaaa-2222-bbbb-3333cccc4444" -MaxEvents 100
```
...
```
PS C:\>Get-AzureRmLog -CorrelationId "00001111-aaaa-2222-bbbb-3333cccc4444" -StartTime 2017-05-22T04:30:00
```
...
```
PS C:\>Get-AzureRmLog -CorrelationId "00001111-aaaa-2222-bbbb-3333cccc4444" -StartTime 2017-04-15T04:30:00 -EndTime 2017-04-25T12:30:00
```
