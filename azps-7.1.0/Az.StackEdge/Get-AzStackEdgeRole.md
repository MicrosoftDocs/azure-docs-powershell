...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.stackedge/get-azstackedgerole) for up-to-date information.
...
## DESCRIPTION
The **Get-AzStackEdgeRole** cmdlet fetches the available IoT roles for a Stack Edge device. You can mention the Name parameter to get the details of a specific IoT role.
