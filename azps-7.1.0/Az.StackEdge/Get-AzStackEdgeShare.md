...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.stackedge/get-azstackedgeshare) for up-to-date information.
...
## DESCRIPTION
The **Get-AzStackEdgeShare** cmdlet gets the available shares for a Stack Edge device. If Name is provided this will get the share by Name.
