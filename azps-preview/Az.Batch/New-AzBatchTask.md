...
{{Fill ApplicationPackageReferences Description}}
...
{{Fill AuthenticationTokenSettings Description}}
...
### -ContainerSettings
{{Fill ContainerSettings Description}}
...
### -ExitConditions
{{Fill ExitConditions Description}}
...
### -Tasks
The collection of tasks to add to a job.
