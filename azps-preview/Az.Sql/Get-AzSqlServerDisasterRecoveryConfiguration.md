...
### -ServerName
The name of the Azure SQL Server the Disaster Recovery Configuration is in.
...
### -VirtualEndpointName
The name of the Azure SQL Server Disaster Recovery Configuration to retrieve.
