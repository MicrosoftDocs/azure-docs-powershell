...
```
Connect-AzAccount [-Environment <String>] [-TenantId <String>] [-Subscription <String>] [-ContextName <String>]
...
```
Connect-AzAccount [-Environment <String>] -Credential <PSCredential> [-ServicePrincipal] -TenantId <String>
...
```
Connect-AzAccount [-Environment <String>] [-TenantId <String>] -AccessToken <String>
...
### ManagedServiceLogin
```
Connect-AzAccount [-Environment <String>] [-TenantId <String>] [-AccountId <String>] [-Identity]
