...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.stackedge/new-azstackedgeuser) for up-to-date information.
...
## DESCRIPTION
The **New-AzStackEdgeUser** cmdlet creates a new user for the Stack Edge device. Creation of only users of type `Share` is supported.
