...
online version: https://learn.microsoft.com/powershell/module/az.informatica/remove-azinformaticaorganization
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Informatica/Informatica/help/Remove-AzInformaticaOrganization.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Informatica/Informatica/help/Remove-AzInformaticaOrganization.md
...
### Delete (Default)
```
Remove-AzInformaticaOrganization -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzInformaticaOrganization -InputObject <IInformaticaIdentity> [-DefaultProfile <PSObject>] [-AsJob]
