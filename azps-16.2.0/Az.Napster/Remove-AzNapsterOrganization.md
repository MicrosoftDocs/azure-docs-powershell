...
online version: https://learn.microsoft.com/powershell/module/az.napster/remove-aznapsterorganization
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Napster/Napster/help/Remove-AzNapsterOrganization.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Napster/Napster/help/Remove-AzNapsterOrganization.md
---
...
### Delete (Default)
```
Remove-AzNapsterOrganization -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzNapsterOrganization -InputObject <INapsterIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
