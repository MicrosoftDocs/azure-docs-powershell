...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/FileShare/FileShare/help/Update-AzFileShareSnapshot.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/FileShare/FileShare/help/Update-AzFileShareSnapshot.md
---
...
```
Update-AzFileShareSnapshot -Name <String> -FileShareInputObject <IFileShareIdentity> [-Metadata <Hashtable>]
...
Parameter Sets: UpdateExpanded, UpdateViaIdentityFileShareExpanded, UpdateViaIdentityExpanded
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaJsonString, UpdateViaJsonFilePath, UpdateViaIdentityFileShareExpanded
Aliases:
