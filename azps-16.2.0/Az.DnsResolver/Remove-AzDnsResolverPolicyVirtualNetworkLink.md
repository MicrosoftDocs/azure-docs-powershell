...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DnsResolver/DnsResolver/help/Remove-AzDnsResolverPolicyVirtualNetworkLink.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DnsResolver/DnsResolver/help/Remove-AzDnsResolverPolicyVirtualNetworkLink.md
---
...
```
Remove-AzDnsResolverPolicyVirtualNetworkLink -Name <String>
 -DnsResolverPolicyInputObject <IDnsResolverIdentity> [-IfMatch <String>] [-DefaultProfile <PSObject>] [-AsJob]
