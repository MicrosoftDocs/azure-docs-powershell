...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Discovery/Discovery/help/New-AzDiscoveryChatModelDeployment.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Discovery/Discovery/help/New-AzDiscoveryChatModelDeployment.md
...
```
New-AzDiscoveryChatModelDeployment -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WorkspaceName <String> -Location <String> [-Capacity <Int32>] [-ModelFormat <String>] [-ModelName <String>]
 [-ModelVersion <String>] [-SkuName <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob]
...
```
New-AzDiscoveryChatModelDeployment -Name <String> -WorkspaceInputObject <IDiscoveryIdentity> -Location <String>
 [-Capacity <Int32>] [-ModelFormat <String>] [-ModelName <String>] [-ModelVersion <String>] [-SkuName <String>]
