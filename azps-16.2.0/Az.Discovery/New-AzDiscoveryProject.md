...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Discovery/Discovery/help/New-AzDiscoveryProject.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Discovery/Discovery/help/New-AzDiscoveryProject.md
...
```
New-AzDiscoveryProject -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -WorkspaceName <String> -Location <String> [-SettingBehaviorPreference <String>]
 [-StorageContainerId <String[]>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
