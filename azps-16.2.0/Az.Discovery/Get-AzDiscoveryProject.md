...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Discovery/Discovery/help/Get-AzDiscoveryProject.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Discovery/Discovery/help/Get-AzDiscoveryProject.md
...
### List (Default)
```
Get-AzDiscoveryProject -ResourceGroupName <String> [-SubscriptionId <String[]>] -WorkspaceName <String>
...
### Get
```
Get-AzDiscoveryProject -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 -WorkspaceName <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDiscoveryProject -InputObject <IDiscoveryIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
