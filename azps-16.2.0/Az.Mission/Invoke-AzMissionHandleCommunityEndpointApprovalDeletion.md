...
online version: https://learn.microsoft.com/powershell/module/az.mission/invoke-azmissionhandlecommunityendpointapprovaldeletion
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/Invoke-AzMissionHandleCommunityEndpointApprovalDeletion.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/Invoke-AzMissionHandleCommunityEndpointApprovalDeletion.md
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalDeletion -CommunityEndpointName <String> -CommunityName <String>
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalDeletion -CommunityEndpointName <String>
 -CommunityInputObject <IMissionIdentity> -ResourceRequestAction <String> [-DefaultProfile <PSObject>] [-AsJob]
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalDeletion -CommunityEndpointName <String>
 -CommunityInputObject <IMissionIdentity> -Body <IApprovalDeletionCallbackRequest> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Invoke-AzMissionHandleCommunityEndpointApprovalDeletion -InputObject <IMissionIdentity>
