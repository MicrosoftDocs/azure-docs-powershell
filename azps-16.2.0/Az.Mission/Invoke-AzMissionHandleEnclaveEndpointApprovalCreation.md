...
online version: https://learn.microsoft.com/powershell/module/az.mission/invoke-azmissionhandleenclaveendpointapprovalcreation
schema: 2.0.0
...
```
Invoke-AzMissionHandleEnclaveEndpointApprovalCreation -EnclaveEndpointName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -VirtualEnclaveName <String> -ApprovalStatus <String>
...
```
Invoke-AzMissionHandleEnclaveEndpointApprovalCreation -EnclaveEndpointName <String>
 -VirtualEnclaveInputObject <IMissionIdentity> -ApprovalStatus <String> -ResourceRequestAction <String>
...
```
Invoke-AzMissionHandleEnclaveEndpointApprovalCreation -EnclaveEndpointName <String>
 -VirtualEnclaveInputObject <IMissionIdentity> -Body <IApprovalCallbackRequest> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Invoke-AzMissionHandleEnclaveEndpointApprovalCreation -EnclaveEndpointName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -VirtualEnclaveName <String> -Body <IApprovalCallbackRequest>
...
```
Invoke-AzMissionHandleEnclaveEndpointApprovalCreation -InputObject <IMissionIdentity> -ApprovalStatus <String>
 -ResourceRequestAction <String> [-ApprovalCallbackPayload <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### HandleViaIdentity
```
Invoke-AzMissionHandleEnclaveEndpointApprovalCreation -InputObject <IMissionIdentity>
