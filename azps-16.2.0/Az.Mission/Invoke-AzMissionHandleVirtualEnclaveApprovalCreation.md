...
online version: https://learn.microsoft.com/powershell/module/az.mission/invoke-azmissionhandlevirtualenclaveapprovalcreation
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/Invoke-AzMissionHandleVirtualEnclaveApprovalCreation.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/Invoke-AzMissionHandleVirtualEnclaveApprovalCreation.md
...
```
Invoke-AzMissionHandleVirtualEnclaveApprovalCreation -ResourceGroupName <String> [-SubscriptionId <String>]
 -VirtualEnclaveName <String> -ApprovalStatus <String> -ResourceRequestAction <String>
...
```
Invoke-AzMissionHandleVirtualEnclaveApprovalCreation -ResourceGroupName <String> [-SubscriptionId <String>]
 -VirtualEnclaveName <String> -Body <IApprovalCallbackRequest> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### HandleViaIdentityExpanded
```
Invoke-AzMissionHandleVirtualEnclaveApprovalCreation -InputObject <IMissionIdentity> -ApprovalStatus <String>
...
### HandleViaIdentity
```
Invoke-AzMissionHandleVirtualEnclaveApprovalCreation -InputObject <IMissionIdentity>
