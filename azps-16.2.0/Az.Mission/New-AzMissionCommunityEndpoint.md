...
online version: https://learn.microsoft.com/powershell/module/az.mission/new-azmissioncommunityendpoint
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/New-AzMissionCommunityEndpoint.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/New-AzMissionCommunityEndpoint.md
---

# New-AzMissionCommunityEndpoint
...
```
New-AzMissionCommunityEndpoint -Name <String> -CommunityName <String> -ResourceGroupName <String>
...
```
New-AzMissionCommunityEndpoint -Name <String> -CommunityInputObject <IMissionIdentity> -Location <String>
