...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/Get-AzMissionDedicatedHub.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/Get-AzMissionDedicatedHub.md
...
```
Get-AzMissionDedicatedHub -Name <String> -CommunityInputObject <IMissionIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzMissionDedicatedHub -InputObject <IMissionIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
