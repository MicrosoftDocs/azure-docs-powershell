...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ManagedNetworkFabric/ManagedNetworkFabric/help/Update-AzNetworkFabricL2IsolationDomain.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ManagedNetworkFabric/ManagedNetworkFabric/help/Update-AzNetworkFabricL2IsolationDomain.md
...
Update-AzNetworkFabricL2IsolationDomain -InputObject <IManagedNetworkFabricIdentity> [-Annotation <String>]
 [-EnableSystemAssignedIdentity <Boolean>] [-ExtendedVlan <String>] [-Mtu <Int32>] [-NetworkFabricId <String>]
 [-NetworkToNetworkInterconnectId <String>] [-Tag <Hashtable>] [-UserAssignedIdentity <String[]>]
 [-VlanId <Int32>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
