...
### List (Default)
```
Get-AzNetworkCloudL2Network [-SubscriptionId <String[]>] [-SkipToken <String>] [-Top <Int32>]
...
### List1
```
Get-AzNetworkCloudL2Network -ResourceGroupName <String> [-SubscriptionId <String[]>] [-SkipToken <String>]
