...
### List (Default)
```
Get-AzNetworkCloudRack [-SubscriptionId <String[]>] [-SkipToken <String>] [-Top <Int32>]
...
### List1
```
Get-AzNetworkCloudRack -ResourceGroupName <String> [-SubscriptionId <String[]>] [-SkipToken <String>]
