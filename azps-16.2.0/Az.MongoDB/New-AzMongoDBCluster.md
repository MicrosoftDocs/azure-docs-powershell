...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MongoDB/MongoDB/help/New-AzMongoDBCluster.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MongoDB/MongoDB/help/New-AzMongoDBCluster.md
...
```
New-AzMongoDBCluster -Name <String> -ProjectName <String> -OrganizationInputObject <IMongoDbIdentity>
 [-ClusterTier <String>] [-RegionName <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
New-AzMongoDBCluster -Name <String> -ProjectInputObject <IMongoDbIdentity> [-ClusterTier <String>]
 [-RegionName <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
