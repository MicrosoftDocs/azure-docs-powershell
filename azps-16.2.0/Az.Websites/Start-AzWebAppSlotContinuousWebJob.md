...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Websites/Websites/help/Start-AzWebAppSlotContinuousWebJob.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Websites/Websites/help/Start-AzWebAppSlotContinuousWebJob.md
---
...
```
Start-AzWebAppSlotContinuousWebJob -Name <String> -SlotName <String> -SiteInputObject <IWebsitesIdentity>
...
```
Start-AzWebAppSlotContinuousWebJob -SlotName <String> -ContinuouswebjobInputObject <IWebsitesIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Start, StartViaIdentitySite, StartViaIdentityContinuouswebjob
Aliases:
