...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DevCenter/DevCenter/help/New-AzDevCenterAdminNetworkConnection.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DevCenter/DevCenter/help/New-AzDevCenterAdminNetworkConnection.md
---
...
```
New-AzDevCenterAdminNetworkConnection -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-OrganizationUnit <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf]
...
<a name='example-1-create-an-azure-ad-joined-network-connection'></a>

### Example 1: Create a Microsoft Entra joined network connection
```powershell
...
This command creates a hybid Microsoft Entra joined network connection named "eastusNetwork" in the resource group "testRg".

<a name='example-3-create-an-azure-ad-joined-network-connection-using-inputobject'></a>

### Example 3: Create a Microsoft Entra joined network connection using InputObject
```powershell
