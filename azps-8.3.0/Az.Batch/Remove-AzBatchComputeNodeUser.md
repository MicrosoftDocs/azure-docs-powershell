...
online version: https://learn.microsoft.com/powershell/module/az.batch/remove-azbatchcomputenodeuser
schema: 2.0.0
...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.batch/remove-azbatchcomputenodeuser) for up-to-date information.
...
### Example 1: Delete a user from a compute node
```powershell
