...
online version: https://learn.microsoft.com/powershell/module/az.network/new-azsecuritypartnerprovider
schema: 2.0.0
...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.network/new-azsecuritypartnerprovider) for up-to-date information.
...
## DESCRIPTION
The **New-AzSecurityPartnerProvider** cmdlet creates an Azure SecurityPartnerProvider
...
### -VirtualHub
The virtual hub Id that the security partner provider is attached to
