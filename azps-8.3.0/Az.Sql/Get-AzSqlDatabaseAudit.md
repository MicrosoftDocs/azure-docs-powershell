...
online version: https://learn.microsoft.com/powershell/module/az.sql/Get-AzSqlDatabaseAudit
schema: 2.0.0
...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.sql/get-azsqldatabaseaudit) for up-to-date information.
...
## DESCRIPTION
The **Get-AzSqlDatabaseAudit** cmdlet gets the auditing settings of an Azure SQL database.
