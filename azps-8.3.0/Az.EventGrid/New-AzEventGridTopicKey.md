...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.eventgrid/new-azeventgridtopickey) for up-to-date information.
...
### Example 1
```powershell
New-AzEventGridTopicKey -ResourceGroup MyResourceGroupName -TopicName Topic1 -KeyName key1
```
...
### Example 2
```powershell
Get-AzEventGridTopic -ResourceGroup MyResourceGroupName -Name Topic1 | New-AzEventGridTopicKey -KeyName "key1"
```
