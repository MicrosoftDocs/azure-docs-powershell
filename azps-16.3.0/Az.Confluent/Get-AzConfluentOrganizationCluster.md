...
online version: https://learn.microsoft.com/powershell/module/az.confluent/get-azconfluentorganizationcluster
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Confluent/Confluent/help/Get-AzConfluentOrganizationCluster.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Confluent/Confluent/help/Get-AzConfluentOrganizationCluster.md
---
...
### List (Default)
```
Get-AzConfluentOrganizationCluster -EnvironmentId <String> -OrganizationName <String>
...
```
Get-AzConfluentOrganizationCluster -ClusterId <String> -EnvironmentId <String>
...
```
Get-AzConfluentOrganizationCluster -ClusterId <String> -EnvironmentInputObject <IConfluentIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzConfluentOrganizationCluster -ClusterId <String> -EnvironmentId <String> -OrganizationName <String>
...
### GetViaIdentity
```
Get-AzConfluentOrganizationCluster -InputObject <IConfluentIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
