...
```
Remove-AzEventGridDomainTopic -Name <String> -DomainInputObject <IEventGridIdentity>
...
### DeleteViaIdentity
```
Remove-AzEventGridDomainTopic -InputObject <IEventGridIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
