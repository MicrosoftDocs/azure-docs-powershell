...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ApplicationInsights/ApplicationInsights/help/Get-AzApplicationInsightsWorkbookRevision.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ApplicationInsights/ApplicationInsights/help/Get-AzApplicationInsightsWorkbookRevision.md
---
...
### GetViaIdentityWorkbook
```
Get-AzApplicationInsightsWorkbookRevision -RevisionId <String>
 -WorkbookInputObject <IApplicationInsightsIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Get, GetViaIdentityWorkbook
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ApplicationInsights.Models.IApplicationInsightsIdentity
Parameter Sets: GetViaIdentityWorkbook
Aliases:
