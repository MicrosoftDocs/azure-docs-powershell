...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/CloudHsm/CloudHsm/help/Restore-AzCloudHsm.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/CloudHsm/CloudHsm/help/Restore-AzCloudHsm.md
---
...
```
Restore-AzCloudHsm -ClusterName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -BackupId <String> -BlobContainerUri <String> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
