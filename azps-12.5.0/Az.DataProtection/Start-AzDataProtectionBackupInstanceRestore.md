...
PrefixMatch is a hashtable where each key is the container name being restored and the value is a list of string prefixes for container names for Item level recovery.
