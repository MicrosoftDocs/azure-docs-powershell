...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/NewRelic/NewRelic/help/Get-AzNewRelicMonitorMetricRule.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/NewRelic/NewRelic/help/Get-AzNewRelicMonitorMetricRule.md
---
...
Get-AzNewRelicMonitorMetricRule -MonitorName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 -UserEmail <String> [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
