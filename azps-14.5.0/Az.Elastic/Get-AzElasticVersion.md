...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Elastic/Elastic/help/Get-AzElasticVersion.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Elastic/Elastic/help/Get-AzElasticVersion.md
...
```
Get-AzElasticVersion [-SubscriptionId <String[]>] -Region <String> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
