...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ManagedNetworkFabric/ManagedNetworkFabric/help/Remove-AzNetworkFabricInternalNetwork.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ManagedNetworkFabric/ManagedNetworkFabric/help/Remove-AzNetworkFabricInternalNetwork.md
---
...
```
Remove-AzNetworkFabricInternalNetwork -Name <String>
...
### DeleteViaIdentity
```
Remove-AzNetworkFabricInternalNetwork -InputObject <IManagedNetworkFabricIdentity> [-DefaultProfile <PSObject>]
...
[https://learn.microsoft.com/powershell/module/az.managednetworkfabric/remove-aznetworkfabricinternalnetwork](https://learn.microsoft.com/powershell/module/az.managednetworkfabric/remove-aznetworkfabricinternalnetwork)
