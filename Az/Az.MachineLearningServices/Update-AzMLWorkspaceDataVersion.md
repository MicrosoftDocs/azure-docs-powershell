...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MachineLearningServices/MachineLearningServices/help/Update-AzMLWorkspaceDataVersion.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MachineLearningServices/MachineLearningServices/help/Update-AzMLWorkspaceDataVersion.md
---
...
```
Update-AzMLWorkspaceDataVersion -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzMLWorkspaceDataVersion -Version <String> -DataInputObject <IMachineLearningServicesIdentity>
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded, UpdateViaIdentityWorkspaceExpanded, UpdateViaIdentityDataExpanded
Aliases:
