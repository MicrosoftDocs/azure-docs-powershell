...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MachineLearningServices/MachineLearningServices/help/New-AzMLWorkspaceOnlineDeployment.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MachineLearningServices/MachineLearningServices/help/New-AzMLWorkspaceOnlineDeployment.md
---
...
```
New-AzMLWorkspaceOnlineDeployment -Name <String> -EndpointName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -WorkspaceName <String> -EndpointComputeType <String> -Location <String>
...
```
New-AzMLWorkspaceOnlineDeployment -Name <String> -EndpointName <String>
...
Parameter Sets: CreateExpanded, CreateViaIdentityWorkspaceExpanded, CreateViaIdentityOnlineEndpointExpanded
Aliases:
