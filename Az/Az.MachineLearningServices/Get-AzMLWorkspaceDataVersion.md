...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MachineLearningServices/MachineLearningServices/help/Get-AzMLWorkspaceDataVersion.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MachineLearningServices/MachineLearningServices/help/Get-AzMLWorkspaceDataVersion.md
---
...
### List (Default)
```
Get-AzMLWorkspaceDataVersion -Name <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 -WorkspaceName <String> [-ListViewType <String>] [-OrderBy <String>] [-Skip <String>] [-Tag <String>]
...
### GetViaIdentityData
```
Get-AzMLWorkspaceDataVersion -Version <String> -DataInputObject <IMachineLearningServicesIdentity>
...
```yaml
Type: System.String
Parameter Sets: GetViaIdentityWorkspace, Get, GetViaIdentityData
Aliases:
