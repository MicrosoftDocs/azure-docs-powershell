...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MachineLearningServices/MachineLearningServices/help/Get-AzMLWorkspaceDatastore.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MachineLearningServices/MachineLearningServices/help/Get-AzMLWorkspaceDatastore.md
---
...
Get-AzMLWorkspaceDatastore -ResourceGroupName <String> [-SubscriptionId <String[]>] -WorkspaceName <String>
 [-Count <Int32>] [-IsDefault] [-OrderBy <String>] [-OrderByAsc]
 [-SearchName <System.Collections.Generic.List`1[System.String]>] [-SearchText <String>] [-Skip <String>]
