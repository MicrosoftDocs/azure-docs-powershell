...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/Set-AzMissionCommunity.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Mission/Mission/help/Set-AzMissionCommunity.md
---
...
```
Set-AzMissionCommunity -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -Location <String>
...
```
Set-AzMissionCommunity -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
