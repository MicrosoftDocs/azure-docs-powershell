...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ServiceBus/ServiceBus/help/New-AzServiceBusLocationsNameObject.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ServiceBus/ServiceBus/help/New-AzServiceBusLocationsNameObject.md
---
...
```
New-AzServiceBusLocationsNameObject [-LocationName <String>] [-RoleType <String>]
 [<CommonParameters>]
```
...
Creates an in-memory object of type `NamespaceReplicaLocation`.
An array of `NamespaceReplicaLocation` can be fed as 
