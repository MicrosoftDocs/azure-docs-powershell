...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Kusto/Kusto/help/Remove-AzKustoAttachedDatabaseConfiguration.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Kusto/Kusto/help/Remove-AzKustoAttachedDatabaseConfiguration.md
---
...
```
Remove-AzKustoAttachedDatabaseConfiguration -Name <String> -ClusterInputObject <IKustoIdentity>
...
### DeleteViaIdentity
```
Remove-AzKustoAttachedDatabaseConfiguration -InputObject <IKustoIdentity> [-DefaultProfile <PSObject>] [-AsJob]
