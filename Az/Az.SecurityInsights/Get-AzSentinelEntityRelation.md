...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/SecurityInsights/SecurityInsights/help/Get-AzSentinelEntityRelation.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/SecurityInsights/SecurityInsights/help/Get-AzSentinelEntityRelation.md
---
...
### List (Default)
```
Get-AzSentinelEntityRelation -EntityId <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
```
Get-AzSentinelEntityRelation -RelationName <String> -EntityInputObject <ISecurityInsightsIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
