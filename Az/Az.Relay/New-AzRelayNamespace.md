...
### CreateViaJsonString
```
New-AzRelayNamespace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonString <String>
...
```
New-AzRelayNamespace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
