...
```
Update-AzMobileNetworkSimGroup -InputObject <IMobileNetworkIdentity> [-EnableSystemAssignedIdentity <Boolean>]
 [-EncryptionKeyUrl <String>] [-MobileNetworkId <String>] [-Tag <Hashtable>] [-UserAssignedIdentity <String[]>]
