...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/StackHCI/StackHCI/help/New-AzStackHciDeploymentSetting.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/StackHCI/StackHCI/help/New-AzStackHciDeploymentSetting.md
---
...
```
New-AzStackHciDeploymentSetting -SName <String> -ClusterName <String> -ResourceGroupName <String>
...
```
New-AzStackHciDeploymentSetting -SName <String> -ClusterInputObject <IStackHciIdentity>
