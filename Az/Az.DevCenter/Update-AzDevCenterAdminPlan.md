...
online version: https://learn.microsoft.com/powershell/module/az.devcenter/update-azdevcenteradminplan
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DevCenter/DevCenter/help/Update-AzDevCenterAdminPlan.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DevCenter/DevCenter/help/Update-AzDevCenterAdminPlan.md
---
...
```
Update-AzDevCenterAdminPlan -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
```
Update-AzDevCenterAdminPlan -InputObject <IDevCenterIdentity> [-SkuCapacity <Int32>] [-SkuFamily <String>]
