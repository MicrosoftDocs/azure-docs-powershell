...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/VMware/VMware/help/Invoke-AzVMwareScheduleMaintenance.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/VMware/VMware/help/Invoke-AzVMwareScheduleMaintenance.md
---
...
Invoke-AzVMwareScheduleMaintenance -MaintenanceName <String> -PrivateCloudInputObject <IVMwareIdentity>
 [-Message <String>] [-ScheduleTime <DateTime>] [-DefaultProfile <PSObject>]
...
```
Invoke-AzVMwareScheduleMaintenance -MaintenanceName <String> -PrivateCloudInputObject <IVMwareIdentity>
 -Body <IMaintenanceSchedule> [-DefaultProfile <PSObject>] [-WhatIf]
...
```
Invoke-AzVMwareScheduleMaintenance -MaintenanceName <String> -PrivateCloudName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] -Body <IMaintenanceSchedule>
 [-DefaultProfile <PSObject>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Invoke-AzVMwareScheduleMaintenance -InputObject <IVMwareIdentity> [-Message <String>]
 [-ScheduleTime <DateTime>] [-DefaultProfile <PSObject>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
Parameter Sets: ScheduleViaIdentityPrivateCloud, Schedule, ScheduleViaIdentity
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ScheduleExpanded, ScheduleViaIdentityPrivateCloudExpanded, ScheduleViaIdentityPrivateCloud, Schedule
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ScheduleExpanded, ScheduleViaIdentityPrivateCloudExpanded, ScheduleViaIdentityExpanded
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMware.Models.IVMwareIdentity
Parameter Sets: ScheduleViaIdentityPrivateCloudExpanded, ScheduleViaIdentityPrivateCloud
Aliases:
