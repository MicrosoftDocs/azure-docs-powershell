...
online version: https://learn.microsoft.com/powershell/module/az.scvmm/update-azscvmmvmextension
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ScVmm/ScVmm/help/Update-AzScVmmVMExtension.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ScVmm/ScVmm/help/Update-AzScVmmVMExtension.md
---
...
```
Update-AzScVmmVMExtension -ExtensionName <String> -vmName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Publisher <String>] [-Setting <Hashtable>] [-ProtectedSetting <Hashtable>]
 [-Type <String>] [-TypeHandlerVersion <String>] [-AutoUpgradeMinorVersion] [-EnableAutomaticUpgrade]
 [-ForceUpdateTag <String>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-WhatIf]
