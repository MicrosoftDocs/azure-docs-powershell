...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Confluent/Confluent/help/Get-AzConfluentConnector.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Confluent/Confluent/help/Get-AzConfluentConnector.md
---
...
```
Get-AzConfluentConnector -ClusterId <String> -Name <String> -EnvironmentInputObject <IConfluentIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
```
Get-AzConfluentConnector -Name <String> -ClusterInputObject <IConfluentIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzConfluentConnector -InputObject <IConfluentIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
