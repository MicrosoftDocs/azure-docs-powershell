...
Module Name: Az.Aks
online version: https://learn.microsoft.com/powershell/module/az.aks/get-azaksmanagedclustermeshupgradeprofile
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Aks/Aks/help/Get-AzAksManagedClusterMeshUpgradeProfile.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Aks/Aks/help/Get-AzAksManagedClusterMeshUpgradeProfile.md
---
...
### List (Default)
```
Get-AzAksManagedClusterMeshUpgradeProfile -ResourceGroupName <String> -ResourceName <String>
...
```
Get-AzAksManagedClusterMeshUpgradeProfile -Mode <String> -ManagedClusterInputObject <IAksIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzAksManagedClusterMeshUpgradeProfile -Mode <String> -ResourceGroupName <String> -ResourceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzAksManagedClusterMeshUpgradeProfile -InputObject <IAksIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
