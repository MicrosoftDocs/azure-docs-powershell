...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Aks/Aks/help/Remove-AzAksMaintenanceConfiguration.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Aks/Aks/help/Remove-AzAksMaintenanceConfiguration.md
---
...
```
Remove-AzAksMaintenanceConfiguration -ConfigName <String> -ManagedClusterInputObject <IAksIdentity>
...
### DeleteViaIdentity
```
Remove-AzAksMaintenanceConfiguration -InputObject <IAksIdentity> [-DefaultProfile <PSObject>] [-Break]
