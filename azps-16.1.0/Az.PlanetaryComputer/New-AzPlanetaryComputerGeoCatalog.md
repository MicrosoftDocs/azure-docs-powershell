...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/PlanetaryComputer/PlanetaryComputer/help/New-AzPlanetaryComputerGeoCatalog.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/PlanetaryComputer/PlanetaryComputer/help/New-AzPlanetaryComputerGeoCatalog.md
---
...
```
New-AzPlanetaryComputerGeoCatalog -CatalogName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-AutoGeneratedDomainNameLabelScope <String>] [-EnableSystemAssignedIdentity]
