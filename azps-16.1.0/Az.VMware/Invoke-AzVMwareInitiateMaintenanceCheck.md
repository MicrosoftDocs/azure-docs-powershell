...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/VMware/VMware/help/Invoke-AzVMwareInitiateMaintenanceCheck.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/VMware/VMware/help/Invoke-AzVMwareInitiateMaintenanceCheck.md
---
...
### InitiateViaIdentity
```
Invoke-AzVMwareInitiateMaintenanceCheck -InputObject <IVMwareIdentity> [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
