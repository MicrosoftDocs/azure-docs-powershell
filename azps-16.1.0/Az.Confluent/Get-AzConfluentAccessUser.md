...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Confluent/Confluent/help/Get-AzConfluentAccessUser.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Confluent/Confluent/help/Get-AzConfluentAccessUser.md
---
...
Get-AzConfluentAccessUser -OrganizationName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-SearchFilter <Hashtable>] [-DefaultProfile <PSObject>] [-WhatIf]
...
```
Get-AzConfluentAccessUser -OrganizationName <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 -Body <IListAccessRequestModel> [-DefaultProfile <PSObject>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
