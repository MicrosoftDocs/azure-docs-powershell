...
```powershell
New-AzBotService -resourcegroupname BotTest-rg -name BotTest2 -ApplicationId "11112222-bbbb-3333-cccc-4444dddd5555" -Location global -Sku F0 -Description "123134" -Webapp
```
