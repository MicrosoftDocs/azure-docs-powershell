...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.synapse/remove-azsynapsedataflow) for up-to-date information.
...
## DESCRIPTION
The **Remove-AzSynapseDataFlow** cmdlet removes a data flow from workspace.
