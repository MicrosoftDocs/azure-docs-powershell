...
> [!NOTE]
> Solutions is being deprecated, please use [az monitor log-analytics solution](/cli/azure/monitor/log-analytics/solution) and [Get-AzMonitorLogAnalyticsSolution](~/az.monitoringsolutions/get-azmonitorloganalyticssolution.md?view=azps-5.9.0) instead if this command.
