...
The asterik character, '<em>', is accepted only as the first character of an FQDN in the list. When used, the asterik matches any number of characters. (e.g. '</em>msn.com' will match msn.com and all its subdomains)
