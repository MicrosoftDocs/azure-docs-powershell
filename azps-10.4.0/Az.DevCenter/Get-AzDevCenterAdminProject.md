...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DevCenter/DevCenter/help/Get-AzDevCenterAdminProject.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/DevCenter/DevCenter/help/Get-AzDevCenterAdminProject.md
---
...
### GetViaIdentity
```
Get-AzDevCenterAdminProject -InputObject <IDevCenterIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
