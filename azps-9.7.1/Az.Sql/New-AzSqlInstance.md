...
### Example 7: Create a new instance with External(Microsoft Entra ID) Administrator, Microsoft Entra ID Only Authentication and no SqlAdministratorCredentials
...
This command creates a new instance with external administrator properties and Microsoft Entra ID only authentication enabled.
...
### -AssignIdentity
Generate and assign a Microsoft Entra ID Identity for this Managed instance for use with key management services like Azure KeyVault.
