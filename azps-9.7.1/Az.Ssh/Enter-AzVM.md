...
Users can login using Microsoft Entra ID issued certificates or using local user credentials. We recommend login using Microsoft Entra ID issued certificates when possible.
