...
### Example 6: Create a Storage account with Azure Files Microsoft Entra DS Authentication, and enable large file share.
```powershell
...
This command creates a Storage account with Azure Files Microsoft Entra DS Authentication, and enable large file share.
...
### -AllowedCopyScope
Set restrict copy to and from Storage Accounts within a Microsoft Entra tenant or with Private Links to the same VNet. Possible values include: 'PrivateLink', 'Microsoft Entra ID'
