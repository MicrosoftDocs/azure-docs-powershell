...
The map of the name of the alias of each custom Open Microsoft Entra Connect provider to the
        configuration settings of the custom Open Microsoft Entra Connect provider.
