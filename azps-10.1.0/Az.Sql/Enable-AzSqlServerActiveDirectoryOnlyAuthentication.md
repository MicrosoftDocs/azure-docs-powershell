...
## DESCRIPTION
The **Enable-AzSqlServerActiveDirectoryOnlyAuthentication** cmdlet enables Microsoft Entra ID only authentication requirement for an AzureSQL Server in the current subscription.
...
This command enables Microsoft Entra ID only authentication requirement for an AzureSQL server named Server01 that is associated with a resource group named ResourceGroup01.
