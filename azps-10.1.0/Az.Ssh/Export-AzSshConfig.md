...
Users can create ssh config files that use Microsoft Entra issued certificates or local user credentials.
...
### Example 1: Export a SSH configuration file for connecting to a resource using Microsoft Entra issued certificates for authentication.
```powershell
...
### Example 2: Export a SSH configuration file for connecting to the Public Ip of an Azure Virtual Machine using Microsoft Entra issued certificates.
```powershell
