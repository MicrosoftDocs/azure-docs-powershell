...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Kusto/Kusto/help/Update-AzKustoSandboxCustomImage.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Kusto/Kusto/help/Update-AzKustoSandboxCustomImage.md
---
...
```
Update-AzKustoSandboxCustomImage -Name <String> -ClusterInputObject <IKustoIdentity> [-BaseImageName <String>]
...
```
Update-AzKustoSandboxCustomImage -Name <String> -ClusterInputObject <IKustoIdentity>
