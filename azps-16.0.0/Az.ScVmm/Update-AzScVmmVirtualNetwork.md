...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ScVmm/ScVmm/help/Update-AzScVmmVirtualNetwork.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ScVmm/ScVmm/help/Update-AzScVmmVirtualNetwork.md
...
```powershell
Update-AzScVmmVirtualNetwork -Name "test-vnet" -ResourceGroupName "test-rg-01" -SubscriptionId "aaaa0a0a-bb1b-cc2c-dd3d-eeeeee4e4e4e" -Tag @{"key-1"="value-1"}
```
