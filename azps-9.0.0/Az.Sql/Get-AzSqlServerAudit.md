...
online version: https://learn.microsoft.com/powershell/module/az.sql/Get-AzSqlServerAudit
schema: 2.0.0
...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.sql/get-azsqlserveraudit) for up-to-date information.
...
## DESCRIPTION
The **Get-AzSqlServerAudit** cmdlet gets the auditing settings of an Azure SQL server.
