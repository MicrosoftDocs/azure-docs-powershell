...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.attestation/get-azattestationpolicysigners) for up-to-date information.
...
### Example 2
```powershell
Get-AzAttestationPolicySigners -Name pshtest2 -ResourceGroupName psh-test-rg
```
