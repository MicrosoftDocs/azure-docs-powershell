...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MobileNetwork/MobileNetwork/help/New-AzMobileNetwork.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/MobileNetwork/MobileNetwork/help/New-AzMobileNetwork.md
---
...
```
New-AzMobileNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -Location <String>
...
### CreateViaJsonString
```
New-AzMobileNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] -JsonString <String>
...
```
New-AzMobileNetwork -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
