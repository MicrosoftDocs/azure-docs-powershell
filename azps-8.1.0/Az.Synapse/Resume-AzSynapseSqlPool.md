...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.synapse/resume-azsynapsesqlpool) for up-to-date information.

## SYNTAX

### ResumeByNameParameterSet (Default)
```
...
## DESCRIPTION
The **Resume-AzSynapseSqlPool** cmdlet resumes an Azure Synapse Analytics SQL pool.
