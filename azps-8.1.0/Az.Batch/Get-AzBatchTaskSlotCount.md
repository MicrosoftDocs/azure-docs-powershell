...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.batch/get-azbatchtaskslotcount) for up-to-date information.
...
## DESCRIPTION
The **Get-AzBatchTaskSlotCount** cmdlet gets the Azure Batch task slot counts for a Batch job.
