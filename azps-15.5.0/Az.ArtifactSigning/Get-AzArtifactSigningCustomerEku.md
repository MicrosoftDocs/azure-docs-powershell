...
online version: https://learn.microsoft.com/powershell/module/az.artifactsigning/get-azartifactsigningcustomereku
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ArtifactSigning/ArtifactSigning/help/Get-AzArtifactSigningCustomerEku.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/ArtifactSigning/ArtifactSigning/help/Get-AzArtifactSigningCustomerEku.md
---
...
```
Get-AzArtifactSigningCustomerEku [-AccountName] <String> [-ProfileName] <String> [-EndpointUrl] <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### ByMetadataFileParameterSet
```
Get-AzArtifactSigningCustomerEku [-MetadataFilePath] <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```
