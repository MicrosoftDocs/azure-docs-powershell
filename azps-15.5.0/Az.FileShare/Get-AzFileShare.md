...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/FileShare/FileShare/help/Get-AzFileShare.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/FileShare/FileShare/help/Get-AzFileShare.md
---
...
### List (Default)
```
Get-AzFileShare [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzFileShare -InputObject <IFileShareIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
