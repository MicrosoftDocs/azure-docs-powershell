...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Confluent/Confluent/help/Update-AzConfluentTopic.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Confluent/Confluent/help/Update-AzConfluentTopic.md
---
...
```
Update-AzConfluentTopic -ClusterId <String> -Name <String> -EnvironmentInputObject <IConfluentIdentity>
...
```
Update-AzConfluentTopic -Name <String> -ClusterInputObject <IConfluentIdentity> [-ConfigRelated <String>]
 [-InputConfig <ITopicsInputConfig[]>] [-Kind <String>] [-MetadataResourceName <String>]
 [-MetadataSelf <String>] [-PartitionReassignmentRelated <String>] [-PartitionRelated <String>]
 [-PartitionsCount <String>] [-ReplicationFactor <String>] [-TopicId <String>] [-DefaultProfile <PSObject>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
