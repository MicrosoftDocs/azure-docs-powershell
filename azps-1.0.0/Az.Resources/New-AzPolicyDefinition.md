...
### -Description
The description for the new policy definition.
...
### -DisplayName
The display name for the new policy definition.
...
### -Metadata
The metadata for the new policy definition.
...
### -Name
The name of the new policy definition.
...
### -Parameter
The parameters declaration for the new policy definition.
...
### -Policy
The policy rule for the new policy definition.
