...
### -Description
The description for the new policy assignment.
...
### -DisplayName
The display name for the new policy assignment.
...
### -Metadata
The metadata for the new policy assignment.
...
### -Name
The name of the new policy assignment.
...
### -NotScope
The not scopes for the new policy assignment.
...
### -PolicyDefinition
The policy definition object for the new policy assignment.
...
### -PolicyParameter
The policy parameters file path or string for the new policy assignment.
...
The policy parameters object for the new policy assignment.
...
### -PolicySetDefinition
The policy set definition object for the new policy assignment.
...
### -Scope
The scope of the new policy assignment, e.g.
