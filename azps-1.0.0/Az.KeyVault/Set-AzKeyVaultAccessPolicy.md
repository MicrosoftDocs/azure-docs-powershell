...
### -EmailAddress
Specifies the email address of the user in Azure Active Directory for which to grant permissions.
...
Specifies certificate operation permissions to grant to a user or service principal.
