...
### -InRemovedState
Permanently remove the previously deleted certificate.
...
### -Name
Specifies the name of the certificate in key vault.
...
If this switch is specified, the cmdlet returns the certificate object that was deleted.
...
### -VaultName
Specifies the name of the vault to which this cmdlet adds the certificate.
