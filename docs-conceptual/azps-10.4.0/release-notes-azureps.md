...
- Require Location property for creating top level arm objects.
  _ Made `ApplicationGroupType` required for `New-AzWvdApplicationGroup`.
  _ Made `HostPoolArmPath` required for `New-AzWvdApplicationGroup`. \* Added `PreferredAppGroupType` for `New-AzWvdHostPool`.
...
- Replaced usage of old [AccessProfile API](/rest/api/aks/managedclusters/getaccessprofile) with calls to [ListClusterAdmin](/rest/api/aks/managedclusters/listclusteradmincredentials) and [ListClusterUser](/rest/api/aks/managedclusters/listclusterusercredentials) APIs
...
- Refactored template deployment cmdlets
  ...
  - Created aliases _-AzSubscriptionDeployment for _-AzDeployment cmdlets
...
- Breaking changes:
  ...
  - The parameter set '\_\_AllParameterSets' for cmdlet 'Add-AzIotHubEventHubConsumerGroup' has been removed.
  ...
  - The parameter set '\_\_AllParameterSets' for cmdlet 'Get-AzIotHubEventHubConsumerGroup' has been removed.
  ...
  - The parameter set '\_\_AllParameterSets' for cmdlet 'Remove-AzIotHubEventHubConsumerGroup' has been removed.
...
- Upgrade to Storage Client Library 10.0.1 (the namespace of all objects from this SDK change from 'Microsoft.WindowsAzure.Storage._' to 'Microsoft.Azure.Storage._')
