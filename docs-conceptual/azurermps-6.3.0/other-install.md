...
Without setting up a context to persist credentials across sessions, you'll need to sign in for every new PowerShell session that is started. To learn about persisting your Azure credentials across sessions, see [Persist user credentials across PowerShell sessions](context-persistence.md).