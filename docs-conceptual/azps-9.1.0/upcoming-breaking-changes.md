...
- Cmdlet breaking-change will happen to all parameter set
  - Starting on 10/12/2022 the "New-AzDisk" cmdlet will deploy with the Trusted Launch configuration by default. This includes defaulting the "HyperVGeneration" parameter to "v2". To know more about Trusted Launch, please visit [Trusted launch for Azure virtual machines][trusted-launch-for-azure-virtual-machines].

### `New-AzVM`

- Cmdlet breaking-change will happen to all parameter set
  - Starting on 10/12/2022 the "New-AzVM" cmdlet will deploy with the Trusted Launch configuration by default. To know more about Trusted Launch, please visit [Trusted launch for Azure virtual machines][trusted-launch-for-azure-virtual-machines]
...
- Cmdlet breaking-change will happen to all parameter set
  - Starting on 10/12/2022 the "New-AzVmss" cmdlet will deploy with the Trusted Launch configuration by default. To know more about Trusted Launch, please visit [Trusted launch for Azure virtual machines][trusted-launch-for-azure-virtual-machines]
