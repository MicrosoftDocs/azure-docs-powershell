...
1. To verify the installation was successful, run `Get-InstalledModule -Name AzureRM -AllVersions`
   from PowerShell.
...
1. Choose the subscription you want to use and create a storage account.
...
1. Type the email address and password associated with your account. Azure authenticates and saves
