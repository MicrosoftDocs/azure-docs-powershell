...
- [Breaking changes for Microsoft Azure PowerShell 6.0.0](#breaking-changes-for-microsoft-azure-powershell-600)
    ...
    - [General breaking changes](#general-breaking-changes)
        ...
        - [Context autosave enabled by default](#context-autosave-enabled-by-default)
        - [Removal of Tags alias](#removal-of-tags-alias)
            - [`AzureRM.ApiManagement`](#azurermapimanagement)
            - [`AzureRM.Automation`](#azurermautomation)
            - [`AzureRM.Cdn`](#azurermcdn)
            - [`AzureRM.Compute`](#azurermcompute)
            - [`AzureRM.DataFactories`](#azurermdatafactories)
            - [`AzureRM.DataLakeAnalytics`](#azurermdatalakeanalytics)
            - [`AzureRM.DataLakeStore`](#azurermdatalakestore)
            - [`AzureRM.MachineLearning`](#azurermmachinelearning)
            - [`AzureRM.Media`](#azurermmedia)
            - [`AzureRM.OperationalInsights`](#azurermoperationalinsights)
