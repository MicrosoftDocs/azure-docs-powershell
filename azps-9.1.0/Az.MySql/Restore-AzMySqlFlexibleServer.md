...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.mysql/restore-azmysqlflexibleserver) for up-to-date information.
