...
> [!NOTE]
>This is the previous version of our documentation. Please consult [the most recent version](/powershell/module/az.servicefabric/update-azservicefabricreliability) for up-to-date information.
...
### -NodeType
Specify Service Fabric node type name. This setting is only required if there are multiple primary node types.
