...
### Example 2: Create a new Azure SQL Database server with External(Microsoft Entra ID) Administrator, Microsoft Entra ID Only Authentication and no SqlAdministratorCredentials
...
This command creates a version 12 Azure SQL Database server with external administrator properties and Microsoft Entra ID only authentication enabled.
