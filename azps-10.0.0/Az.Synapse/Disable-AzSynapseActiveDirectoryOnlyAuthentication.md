...
## SYNOPSIS
Disables Microsoft Entra ID only authentication for a specific Synapse workspace.
...
## DESCRIPTION
The **Disable-AzSynapseActiveDirectoryOnlyAuthentication** cmdlet disables Microsoft Entra ID only authentication for a specific Synapse workspace.
...
```
This command disables Microsoft Entra ID only authentication for workspace ContosoWorkspace.
...
ContosoWorkspace                              False Consistent 3/23/2022 8:27:47 AM
```
This command disables Microsoft Entra ID only authentication for workspace ContosoWorkspace through pipeline.
...
ContosoWorkspace                              False Consistent 3/23/2022 8:27:47 AM
```
This command disables Microsoft Entra ID only authentication for workspace ContosoWorkspace by ResourceId.
