...
```powershell
# ObjectId is the string representation of a GUID for directory object, application, in Microsoft Entra ID.
...
```powershell
# ApplicationId is AppId of Application object which is different from directory id in Microsoft Entra ID.
