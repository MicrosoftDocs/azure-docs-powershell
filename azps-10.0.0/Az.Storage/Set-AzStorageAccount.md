...
### Example 10: Update a Storage account by enable Azure Files Microsoft Entra DS Authentication and set DefaultSharePermission.
```powershell
...
The command update a Storage account by enable Azure Files Microsoft Entra DS Authentication.
