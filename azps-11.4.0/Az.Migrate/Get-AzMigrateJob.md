...
schema: 2.0.0
content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Migrate/Migrate/help/Get-AzMigrateJob.md
original_content_git_url: https://github.com/Azure/azure-powershell/blob/main/src/Migrate/Migrate/help/Get-AzMigrateJob.md
---
...
### GetById
```
Get-AzMigrateJob [-SubscriptionId <String>] -JobID <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
